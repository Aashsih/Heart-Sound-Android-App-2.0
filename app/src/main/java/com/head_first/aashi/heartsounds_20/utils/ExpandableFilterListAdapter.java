...
public class ExpandableFilterListAdapter extends BaseExpandableListAdapter {
    ...
    private static final int GROUP_LAYOUT_ID = R.layout.expandable_filter_list_group;
    private static final int ITEM_LAYOUT_ID = R.layout.expandable_filter_list_item;
